...
if __name__ == "__main__":
    ...
    for distance in distances:
        ...
        qc0 = QuantumChannel("qc0", tl, distance=distance * 1e3, polarization_fidelity=0.98, attenuation=0.0002)
        qc1 = QuantumChannel("qc1", tl, distance=distance * 1e3, polarization_fidelity=0.98, attenuation=0.0002)
        ...
        # Bob
        detector_params = [{"efficiency": 0.65, "dark_count": 100, "time_resolution": 100},
    ...
    df = pd.DataFrame(log)
    df.to_csv('distance_timebin_alt.csv')
